-- 신규 원고 Discord 알림의 계정 라벨: '스피커' → 'influence'
--
-- 2026-09-07 부로 mih_speaker 계정의 표시 이름은 influence 다(블로그 gdfdhzgfgfhgdj).
-- 내부 슬러그 mih_speaker 는 유지하므로 CASE 의 조건값은 그대로 두고 라벨만 바꾼다.
-- 함수 본문 전체는 20260613010000_notify_new_article_add_url.sql 과 동일하다.
